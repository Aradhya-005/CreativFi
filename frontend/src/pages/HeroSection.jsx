      ...
      <section className="showcase">
        <div>
          ...
          <div class="grid-container">
            <div class="grid-item">
              <img src={assets.Designer} alt="designer" />
            </div>
            <div class="grid-item">
              <img src={assets.Books} alt="books" />
            </div>
            <div class="grid-item">
              <img src={assets.Producer2} alt="producer" />
            </div>
            <div class="grid-item">
              <img src={assets.Graphics} alt="graphics" />
            </div>
            <div class="grid-item">
              <img src={assets.Designer2} alt="designer" />
            </div>
            <div class="grid-item">
              <img src={assets.videoProducer} alt="videoproducer" />
            </div>
            <div class="grid-item">
              <img src={assets.Writer} alt="writer" />
            </div>
            <div class="grid-item">
              <img src={assets.SocialInfluencer} alt="influencer" />
            </div>
          </div>
        </div>
      </section>
